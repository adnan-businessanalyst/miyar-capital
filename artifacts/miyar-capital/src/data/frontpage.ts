...
export const AR: Record<TranslationKey, string> = {
  ...
  fp_wwd_lead: "معيار المالية شركة استثمارية سعودية مستقلة تدير رؤوس الأموال عبر أربعة ركائز متكاملة، وتقدم المشورة للشركات والمساهمين في الصفقات التي ترسم مستقبلهم.",
  fp_wwd_link: "من نحن",
  fp_wwd_link_url: "/who-we-are",
  ...
  fp_svc_ib_p: "خبرات استشارية متخصصة في أسواق رأس المال للشركات والمساهمين الذين يستعدون لصياغة المرحلة القادمة من مسيرتهم.",
