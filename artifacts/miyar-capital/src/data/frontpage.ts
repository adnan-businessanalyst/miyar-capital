...
export const AR: Record<TranslationKey, string> = {
  ...
  fp_prin_left_a: "نعمل بصفة",
  fp_prin_left_hl: "الأصيل",
  fp_prin_left_b: "، لا الموزّع. لا نُطلق إلا ما نرتضيه لأموالنا.",
  ...
  fp_svc_ib_p: "نقدم صناديق إستثمارية وإدارة محافظ إستثمارية خاصة تشمل حلول السيولة والدخل الثابت، وإدارة أسهم الملكية الخاصة، والأصول العقارية، والأسواق الخاصة — للأفراد والمكاتب العائلية والمؤسسات.",
  fp_svc_ib_link: "مستشار الإستثمار",
  fp_svc_ib_url: "/investment-banking",
  fp_svc_am: "إدارة الأصول",
  fp_svc_am_p: "نقدم الاستشارة والترتيب في المصرفية الاستثمارية للشركات والمساهمين والرعاة الماليين: أسواق رأس المال، وصفقات الاندماج والاستحواذ، وترتيب التسهيلات المصرفية و ترتيب صفقات التمويل، والتقييم، والصفقات الاستراتيجية.",
