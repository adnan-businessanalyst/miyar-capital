        ...
        <div className="wrap">
          ...
          <div className="ib-products-grid">
            <div
              ...
              onClick={() => navigate("/investment-banking/capital-markets-advisory")}
            >
            ...
            <div
              className="ib-product-card"
              onClick={() => navigate("/investment-banking/mergers-acquisitions")}
            >
            ...
            <div
              className="ib-product-card"
              onClick={() => navigate("/investment-banking/debt-financing-arrangement")}
            >
            ...
            <div
              className="ib-product-card"
              onClick={() => navigate("/investment-banking/valuation-financial-advisory")}
            >
            ...
            <div
              className="ib-product-card"
              onClick={() => navigate("/investment-banking/real-estate-private-arrangements")}
            >
